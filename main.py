...
#引入路径
import sys
sys.path.append(r"C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master\utils")
sys.path.append(r"C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master\model")
sys.path.append(r'C:\Users\DELL\PycharmProjects\research')
dir = r"C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master/"
from metric import get_ner_fmeasure
from bilstmcrf import BiLSTM_CRF as SeqModel
...
def run(status='decode'):
    ...
    parser.add_argument('--status', choices=['train', 'test', 'decode'], help='update algorithm', default=status)
    parser.add_argument('--savemodel', default=r"C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master\data/saved_model.lstmcrf")
    parser.add_argument('--savedset', help='Dir of saved data setting', default=r"C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master\data/saved_model.lstmcrf.dset")
    parser.add_argument('--train', default=r"C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master\train.char.bmes")
    parser.add_argument('--dev', default=r"C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master\dev.char.bmes")
    parser.add_argument('--test', default=r"C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master\test.char.bmes")
    parser.add_argument('--seg', default="True")
    parser.add_argument('--extendalphabet', default="True")
    parser.add_argument('--raw', default=r'C:\Users\DELL\PycharmProjects\research\named_entity_recognition-master\ResumeNER\input.char.bmes')
    parser.add_argument('--loadmodel', default=r'C:\Users\DELL\PycharmProjects\research\LatticeLSTM-master\data/saved_model.lstmcrf.21.model')
    parser.add_argument('--output', default=r'C:\Users\DELL\PycharmProjects\research\named_entity_recognition-master\ResumeNER\lattice_output.char.bmes')
    ...
    if status == 'train':
        ...
        best_acc,best_p,best_r,best_test,latticelstm_pred = train(data, save_model_dir, seg)
        print("accuracy = ", best_acc, " precision = ", best_p, " recall = ", best_r, " f_measure = ", best_test)
        return best_acc, best_p, best_r, best_test, latticelstm_pred
    elif status == 'test':
...
if __name__ == '__main__':
    best_acc,best_p,best_r,best_test,latticelstm_pred = run()
    print(latticelstm_pred)
